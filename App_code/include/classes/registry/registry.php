<?php
     ...
     * Class:   Registry
     *
     *          This class is directly based on the ConfigMagik class from the
     *          PHP Classes.
     * 
     *          The original information is retained in full.
     *
     *          The class name is changed and the class is modified to be PHP 5
     *          compatible.
     * 
	...
	*/
	...
	public function Registry( $path = null, $synchronize = false, $process_sections = true )
        {
        ...
        {
            $this->Registry( $path, $synchronize, $process_sections ) ;
        }
